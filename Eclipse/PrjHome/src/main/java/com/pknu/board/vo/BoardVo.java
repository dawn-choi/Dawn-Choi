...
public class BoardVo {
	...
	public String toString() {
		return "BoardVo [mid=" + mid + ", mpwd=" + mpwd + ", mname=" + mname + ", memail=" + memail + ", mbirth="
				...
				+ rname + ", cid=" + cid + ", cname=" + cname + ", clvl=" + clvl + ", cparent_id=" + cparent_id
				+ ", orid=" + orid + ", sdate=" + sdate + ", oexp=" + oexp + ", pid=" + pid + ", pname=" + pname
				+ ", pcost=" + pcost + ", ptot=" + ptot + ", tid=" + tid + ", tname=" + tname + ", lid=" + lid
				+ ", lname=" + lname + ", lday=" + lday + ", ltime=" + ltime + ", lhour=" + lhour + ", lsid=" + lsid
