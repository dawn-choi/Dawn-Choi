...
$(function(){
	...
	var responseMessege2 = "<c:out value ="${mpwd}"/>"; 
	if(responseMessege == "1"){
		if(responseMessege2=="" ||responseMessege2==null ){
		alert("똑바로 쳐라 뒤진다 진짜");
			
		}else{
		alert(" 고객님의 비밀번호는 '<c:out value ="${mpwd}"/>' 입니다 ^^ㅗ ");}
	}
})
			...
			<div id="mainImg">
				<div class="login-page">
					<div class="form">
						...
						<p class="message">비밀번호 찾기</p>
						<form class="login-form" action="/getPwd" method="POST" id="find">
